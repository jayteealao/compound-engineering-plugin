...
model: inherit
description: Analyzes specifications, plans, and feature descriptions to map user flows, identify edge cases, and surface gaps before implementation begins.
---
