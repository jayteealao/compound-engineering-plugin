...
model: inherit
description: Performs security audits and vulnerability assessments including OWASP compliance, input validation, auth review, secret scanning, and injection detection.
---
